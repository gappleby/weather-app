...
> **Fork of [aryansoni-git/weather-app](https://github.com/aryansoni-git/weather-app)** — extended with hourly forecasts, location clock and date, public transport departures, auto-refresh, Docker support, and query string configuration.
> This fork is available at **[gappleby/weather-app](https://github.com/gappleby/weather-app)**.

A modern, responsive weather application built using **Next.js 14** and **Tailwind CSS**. This app provides real-time weather data for any city worldwide, utilizing the **OpenWeatherMap API** for current conditions and **Open-Meteo** for hourly forecasts. It is designed to fill the screen and works well as an always-on or kiosk display.  Optional public transport departures add a real local flare for clubs and associations that want to provide local service.

## Demo

![cover](/public/cover.png)

You can try the game live [here](https://gappleby.github.io/weather-app/?city=edinburgh,gb&lat=55.9391&lon=-3.3551&showdepartures=true&departureradius=200)!
...
```
https://gappleby.github.io/weather-app/?city=melbourne,au&lat=-37.8663&lon=145.0293&showdepartures=true&departureradius=150
```
